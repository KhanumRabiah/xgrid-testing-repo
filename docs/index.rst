.. xgridone documentation master file, created by
   sphinx-quickstart on Wed Sep 18 12:40:17 2024.
...
* The Final Remarks section can be edited any time if the review process isn’t in the Done phase. Any user can only see his Final Remarks for a review once that review has been moved to the Done phase.

.. toctree::
   :maxdepth: 2
   :caption: Contents:

   manager_review_cycle
   employee_review_cycle
